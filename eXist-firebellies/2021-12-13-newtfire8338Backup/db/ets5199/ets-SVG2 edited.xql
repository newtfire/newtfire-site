xquery version "3.1";
<svg xmlns="http://www.w3.org/2000/svg" width="4600" height="700">
...
return
    <g>
        <rect x="{$pos * $spacer}" y="{0 - $countActions * 5}" rx="10" ry="10" width="70" height="{$countActions * 5}" stroke="blue" stroke-width="4" fill="turquoise"/>
  ...
  -->   
     <rect x="{$pos * $spacer + 25}" y="{0 - $countActions * 5}" rx="10" ry="10" width="20" height="{$countActions * 5}" stroke="blue" stroke-width="4" fill="yellow"/>
        ...
        {$countSpeakers}
        <text x="20" y="420" letter-spacing="4" font-size="50" stroke="blue">How do gameplay actions (yellow) vary in relation to number of distinct characters (orange) present in game episodes of Assassin's Creed, Odyssey?</text>
        <text x="30" y="500" letter-spacing="4" font-size="50" stroke="grey" stroke-width="1" fill="yellow">Action</text>
        <text x="500" y="500" letter-spacing="4" font-size="50" stroke="grey" stroke-width="1" fill="orange">Speakers</text>
    </g>
}
</g>
</svg>
