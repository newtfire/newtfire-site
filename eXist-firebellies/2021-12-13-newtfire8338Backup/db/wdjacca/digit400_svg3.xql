...
<g transform="translate(30, 30)">
          <line x1="100" y1="100" x2="2000" y2="100" stroke="black" stroke-width="2"/>
          {
            ...
            return
                <g class="circles">
                <circle cx="{$pos*$timelineSpacer - 100}" cy="100" r="{math:sqrt($totalCount div math:pi())*$radiusRatio}" fill="#3EB489" stroke="#013220" stroke-width="{$personCount div $lineLengthen}"/>
