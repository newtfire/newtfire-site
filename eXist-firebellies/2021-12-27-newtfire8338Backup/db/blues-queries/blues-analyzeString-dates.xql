...
for $s in $songTitles
return concat($s, "&#x9;", $d, "&#x9;", "date"), "&#10;");


let $filename := "bluesDecades-Titles.tsv"
let $doc-db-uri := xmldb:store("/db/blues-queries/", $filename, $ThisFileContent, "text/plain")
return $doc-db-uri
(: View this TSV (text/plain) file at http://newtfire.org:8338/exist/rest/db/blues-queries/bluesDecades-Titles.tsv  :)