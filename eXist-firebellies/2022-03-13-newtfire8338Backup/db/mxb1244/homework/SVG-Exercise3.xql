...
{ for $e at $pos in $elections
    ...
    let $electoral_votes := $e/_votes ! xs:integer(.)
    let $popular_percentages := $e/_percentages ! xs:decimal(.)
    ...
    <g id="year-{$year}">
        ...
        <circle cx="100" cy="100" r="50" fill="salmon" opacity=".25"/>
        <circle cx="100" cy="100" r="50" fill="blue" opacity=".25"/>
        <circle cx="100" cy="100" r="50" fill="grey" opacity=".25"/>
