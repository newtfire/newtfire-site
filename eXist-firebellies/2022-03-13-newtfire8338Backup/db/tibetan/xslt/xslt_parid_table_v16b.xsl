    ...
    <xsl:template match="div[@type='Sentence']|div[@type='Verse']|div[@type='Paragraph']|div[@type='Group']|div[@type='Text Colophon']|div[@type='Mantra']|div[@type='Homage']">
        ...
        <xsl:choose>
            <xsl:when test="@col = '1'">
                ...
                <!-- Col = 2 -->
                <xsl:if test="(($position = $last) and (@col &lt; $numWitness))">
                ...
                <!-- Col = 3 -->
                <xsl:if test="(($position = $last) and ((@col + 1) &lt; $numWitness))">
                    <td width="{$cellwidth}%" bgcolor="#cc6699">
                        <xsl:value-of select="' '"/>
                    </td>
                </xsl:if>
                <!-- Col = 4 -->
                <xsl:if test="(($position = $last) and ((@col + 2) &lt; $numWitness))">
                    <td width="{$cellwidth}%" bgcolor="#00aa22">
                        <xsl:value-of select="' '"/>
                    </td>
                </xsl:if>
                <!-- Col = 5 -->
                <xsl:if test="(($position = $last) and ((@col + 3) &lt; $numWitness))">
                    <td width="{$cellwidth}%" bgcolor="#ffff00">
                        <xsl:value-of select="' '"/>
                    </td>
                </xsl:if>
                <!-- Col = 6 -->
                <xsl:if test="(($position = $last) and ((@col + 4) &lt; $numWitness))">
                    <td width="{$cellwidth}%" bgcolor="#00ffff">
                        <xsl:value-of select="' '"/>
                    </td>
                </xsl:if>
                <!-- Col = 7 -->
                <xsl:if test="(($position = $last) and ((@col + 5) &lt; $numWitness))">
                    <td width="{$cellwidth}%" bgcolor="#99ff00">
                        <xsl:value-of select="' '"/>
                    </td>
                </xsl:if>
                <!-- Col = 8 -->
                <xsl:if test="(($position = $last) and ((@col + 6) &lt; $numWitness))">
            ...
            <xsl:when test="@col = '2'">
                ...
                <td width="{$cellwidth}%" bgcolor="#ff00ff">
                    ...
                    <xsl:value-of select="concat('following position = ', following-sibling::*[1]/@col, ' ')"/>
                    <xsl:value-of select="concat('number of witnesses = ', $numWitness, ' ')"/ -->
                    <xsl:apply-templates/>
                </td>
                <!-- CHECK to see if last dataset, if so, append blank field(s) -->
                <!-- Col = 3 -->
            ...
            <xsl:when test="@col = '4'">
                ...
                <!-- Now check to see if there is n-1 gaps -->
                <!-- Col = 3 -->
                <xsl:if test="(($position = $last) and ($position = (@col - 1)) and ((@col + 1) &lt; $numWitness))">
                    <td width="{$cellwidth}%" bgcolor="#cc6699">
                        <xsl:value-of select="' '"/>
                    </td>
                </xsl:if>
                <!-- Col = 4 -->
                <xsl:if test="(($position = $last) and ($position = (@col - 1)) and ((@col + 2) &lt; $numWitness))">
                    <td width="{$cellwidth}%" bgcolor="#00aa22">
                        <xsl:value-of select="' '"/>
                    </td>
                </xsl:if>
                <!-- Col = 5 -->
                <xsl:if test="(($position = $last) and ($position = (@col - 1)) and ((@col + 3) &lt; $numWitness))">
                    <td width="{$cellwidth}%" bgcolor="#ffff00">
                        <xsl:value-of select="' '"/>
                    </td>
                </xsl:if>
                <!-- Now check to see if there is n-2 gaps -->
                <!-- Col = 3 -->
                <xsl:if test="(($position = $last) and ($position = (@col - 2)) and ((@col + 2) &lt; $numWitness))">
                    <td width="{$cellwidth}%" bgcolor="#cc6699">
                        <xsl:value-of select="' '"/>
                    </td>
                </xsl:if>
                <!-- Col = 4 -->
                <xsl:if test="(($position = $last) and ($position = (@col - 2)) and ((@col + 3) &lt; $numWitness))">
                    <td width="{$cellwidth}%" bgcolor="#00aa22">
                        <xsl:value-of select="' '"/>
                    </td>
                </xsl:if>
                <!-- Now check to see if there is n-3 gaps -->
                <!-- Col = 3 -->
                <xsl:if test="(($position = $last) and ($position = (@col - 3)) and ((@col + 3) &lt; $numWitness))">
                    <td width="{$cellwidth}%" bgcolor="#cc6699">
                        <xsl:value-of select="' '"/>
                    </td>
                </xsl:if>
