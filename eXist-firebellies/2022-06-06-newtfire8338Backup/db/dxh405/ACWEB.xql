...
<line x1 = "20" y1 = "0" x2="{$max-Width}" y2="0" stroke="black" stroke-width="1"/>
<!--X axis above here -->

<line x1 = "20" y1 = "0" x2="20" y2="{$max-Height}" stroke="black" stroke-width="1"/>
<!--Y axis above here -->
{
...
let $filename := "assassinsBarGraphWEB.svg"
let $doc-db-uri := xmldb:store("/db/dxh405/", $filename, $ThisFileContent)
return $doc-db-uri
(: View output at http://newtfire.org:8338/exist/rest/db/dxh405/assassinsBarGraphWEB.svg :)
