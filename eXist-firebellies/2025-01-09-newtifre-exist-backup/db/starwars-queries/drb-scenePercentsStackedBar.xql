xquery version "3.1";
(: ebb: Find out which Star Wars drafts are the "longest" in count of scenes. :)
...
(: To stack each portion on top of the others, we need a way to know how much comes before :)
    let $sPrecedingPortion := 
            let $previous := $chronSequence[position() lt $pos]
